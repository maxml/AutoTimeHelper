...
public class WalkEventCRUD {

    private DatabaseReference userRef;

    public WalkEventCRUD() {
    ...
    public void create(WalkAction walkAction) {
        ...
        final long dayCount = Utils.getDayCount(walkAction.getStartDate());
        if (dayCount == -1) {
        ...
        userRef.child(dayCount + "")
                ...
                .child(dbId)
                .setValue(walkAction).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
    ...
    private void saveIdAndDay(long dayCount, String id) {
        ...
        data.put("/" + Constants.WALK_DATABASE_PATH + "/" + id, dayCount);
...
//                            List<WalkAction> list = new ArrayList<>();
