...
public class PointCRUD {
	...
	public void create(Point pointStart, Point pointFinish, final Slice slice) {
		...
		Log.i("Point", "Create: Point Start created offline. UUID: " + parsePointStart.getString("UUID"));
		Log.i("Point", "Create: Point Finish created offline. UUID: " + parsePointFinish.getString("UUID"));
		onresult.onResult(parsePointStart,parsePointFinish, slice);
		}
